...
const RoleMenuPermission=react.lazy(()=> import('./views/setups/RoleMenuPermission'))
...
const Warehouses = React.lazy(() => import('./views/purchaseManagement/Warehouse'))
...
{path: '/setups/email', name: 'Email', element: Emails },
  ...
  {path: '/quotationManagement/sales', name: 'Quotations', element: Sales },
    {path: '/quotationManagement/stockTransactions', name: 'StockTransactions', element: StockTransactions },
