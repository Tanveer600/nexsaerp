...
const _nav = [
  ...
  },
  {
    component: CNavGroup,
    name: 'Stakeholders',
    icon: <CIcon icon={cilPeople} customClassName="nav-icon" />, // Multi-users icon
    items: [
      {
        component: CNavItem,
        name: 'Customers',
  ...
  },
  {
    component: CNavGroup,
    name: 'Product',
    icon: <CIcon icon={cilBasket} customClassName="nav-icon" />, // Shopping basket/product icon
    items: [
      {
        component: CNavItem,
        name: 'Product',
  ...
  },
  {
    component: CNavGroup,
    name: 'Vendors',
    icon: <CIcon icon={cilTruck} customClassName="nav-icon" />, // Delivery/Vendor truck icon
    items: [
      {
        component: CNavItem,
        name: 'Vendors',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        to: '/quotationManagement/stockTransactions',
      },
    ],
  },
  {
  ...
  },
  {
    component: CNavGroup,
    name: 'Setups',
    icon: <CIcon icon={cilSettings} customClassName="nav-icon" />, // Cog/Gear icon
    items: [
      {
        component: CNavItem,
        name: 'Users',
      ...
      },
      {
        ...
        to: '/setups/role-menu-permission',
